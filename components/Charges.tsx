...
const Charges: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://www.cosmicrms.com/api/ld-lf/brok')
  ...
  const renderItem = ({ item, index }: { item: any, index: any }) => {
    ...
    return (
      <View style={[styles.row, !isFirst &&  isEven? styles.evencell :null]}>
        ...
        <Text style={[styles.cell, isFirst && styles.thead]}>{formateInt(item.total_client_sharing)}</Text>
      </View>
    );
  };
