...
function MtmIncome() : React.JSX.Element  {
  const navigation = useNavigation();
  const data: TabItem[] = [
    { key: 'COSMIC MTM INCOME', title: 'Cosmic Mtm Income' },
    { key: 'SPECTRA MTM INCOME', title: 'Spectra MTM Income' },
  ];
