...
const SpectraMtmincome: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://www.cosmicrms.com/api/ld-lf/spectramtm')
  ...
  return (
    <LinearGradient colors={['#780206', '#061161']} style={styles.container}>
      <Animated.View style={[styles.innerContainer, animatedStyle]}>
        <Text style={styles.title}>Spectra Mtm</Text>
        {data ? (
          <FlatList
            data={data}
...
export default SpectraMtmincome;
